...
Derivs_Limiter YLimiter = Derivs_Limiter(40000, 1500, 1200); // speed, acceleration when increasing speed, acceleration when decreasing speed
Derivs_Limiter XLimiter = Derivs_Limiter(40000, 1500, 1200); // speed, acceleration when increasing speed, acceleration when decreasing speed
